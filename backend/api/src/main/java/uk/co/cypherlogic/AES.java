...
public static String result;
    ...
    public String encrypt(String Plaintext, String SECRET_KEY) {
        try {
           ...
           return "{\"result\":\"the encrypted message is \"}"+ Base64.getEncoder().encodeToString(
    ...
    public  String decrypt(String Ciphertext, String SECRET_KEY) {
        try {
            ...
            result = "DECRYPTED";
             ...
             return "{\"result\":\"the decrypted message is\"}"+ new String(cipher.doFinal(
...
// driver code
   /* public static void main(String[] args) {
        ...
        String originalString = sc1.nextLine(); //read a string 
